module "health_api" {
  ...
  service_hosts = [
    ...
    "health.containers-linuxtips.internal.com"
  ]
  ...
  environment_variables = [
    ...
    },
    {
      ...
      value = "nutrition-bmr.containers-linuxtips.discovery.com:30000"
    },
    {
      name  = "IMC_SERVICE_ENDPOINT",
      value = "nutrition-imc.containers-linuxtips.discovery.com:30000"
    },
    {
      name  = "RECOMMENDATIONS_SERVICE_ENDPOINT",
      value = "nutrition-recommendations.containers-linuxtips.discovery.com:30000"
    }
  ]
