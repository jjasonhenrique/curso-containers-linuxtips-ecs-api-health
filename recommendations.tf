module "recommendations" {
  ...
  service_hosts = [
    "recommendations.containers-linuxtips.internal.com"
  ]
  ...
  environment_variables = [
    ...
    },
    {
      ...
      value = "nutrition-proteins.containers-linuxtips.discovery.com:30000"
    },
    {
      name  = "WATER_SERVICE_ENDPOINT"
      value = "nutrition-water.containers-linuxtips.discovery.com:30000"
    },
    {
      name  = "CALORIES_SERVICE_ENDPOINT"
      value = "nutrition-calories.containers-linuxtips.discovery.com:30000"
    },
  ]
